...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({
      ...
      price: 3622,
      stock: 20,
      imgUrl: 'https://i.imgur.com/fXemBTP.jpg'
    }),
    Product.create({
      name: 'CV Dazzle Paint',
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
      category:
        'facial enhancement',
      price: 2039000,
      stock: 20,
      imgUrl: 'https://i.imgur.com/s4yXco4.png'
    }),
    Product.create({
      name: 'Augmented Reality Beamers',
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum",
      category:
        'viaion enhancement',
      price: 71800,
      stock: 20,
      imgUrl: 'https://i.imgur.com/hJfRVrT.png'
    }),
    Product.create({
      name: 'UV Flash Goo',
      description:
      ...
      stock: 20,
      imgUrl: 'https://i.imgur.com/Ypcy6Sf.png'
    }),
    Product.create({
      name: 'Kinetic Makeup',
      description:
      ...
      price: 650800,
      stock: 20,
      imgUrl: 'https://i.imgur.com/8VGzq8U.png'
    })
  ])
